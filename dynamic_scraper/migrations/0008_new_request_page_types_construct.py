    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.CharField(default='R', help_text=b'Normal (typically GET) request (default) or form request (typically POST), using Scrapys corresponding request classes (not used for checker).', max_length=1, choices=[('R', b'Request'), ('F', b'FormRequest')])),
