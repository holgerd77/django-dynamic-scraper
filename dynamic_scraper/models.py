...
class Scraper(models.Model):
    ...
    content_type = models.CharField(max_length=1, choices=CONTENT_TYPE_CHOICES, default='H', help_text="Data type format of scraped pages (for JSON use JSONPath instead of XPath)")
