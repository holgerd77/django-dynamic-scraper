...
class RequestPageType(models.Model):
    ...
    scraped_obj_attr = models.ForeignKey(ScrapedObjAttr, on_delete=models.CASCADE, blank=True, null=True, help_text="Empty for main page, attribute of type DETAIL_PAGE_URL scraped from main page for detail pages.")
...
class LogMarker(models.Model):
    ...
    scraper = models.ForeignKey(Scraper, on_delete=models.CASCADE, blank=True, null=True)
