...
class ScraperRunTest(ScraperTest):
    ...
    def process_image_test(self, sub_dirs):
        imgs = [
        ...
        for sub_dir in sub_dirs:
            for img in imgs:
                expected_paths.append(os.path.join(self.PROJECT_ROOT, sub_dir, img))
    ...
    def test_img_flat_storage(self):
        sub_dirs = ['imgs',]
        self.process_image_test(sub_dirs)
    
    
    def test_img_sub_directory_storage(self):
        sub_dirs = ['imgs',]
        self.process_image_test(sub_dirs)
